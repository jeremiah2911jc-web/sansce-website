...
const FIELD_GROUPS = {
  land: {
    ...
    fields: [
      { id: "landSequence", label: "序號", outputHeaders: ["序號"], aliases: ["序號"] },
      ...
      { id: "ownerReferenceId", label: "權利人編號", outputHeaders: ["地主編號"], aliases: ["地主編號", "權利人編號", "所有權人編號", "參考編號"] },
      {
        id: "ownerName",
        label: "所有權人",
      ...
      { id: "transcriptAddress", label: "謄本地址", outputHeaders: ["謄本地址"], aliases: ["謄本地址", "地址", "通訊地址", "戶籍地址", "住址"] },
    ],
  },
  building: {
    label: "建物清冊",
    ...
    ownershipSignalFieldIds: ["registrationOrder", "ownerReferenceId", "ownerName", "maskedIdentityCode", "shareNumerator", "shareDenominator", "shareText"],
    fields: [
      { id: "buildingSequence", label: "編號", outputHeaders: ["編號"], aliases: ["編號"] },
      { id: "city", label: "縣市", outputHeaders: ["縣市"], aliases: ["縣市", "市縣", "city", "county"] },
      { id: "district", label: "行政區", outputHeaders: ["行政區"], aliases: ["行政區", "鄉鎮市區", "區", "district", "town"] },
      { id: "section", label: "地段", outputHeaders: ["段別", "地段"], aliases: ["地段", "段別", "段名", "section"] },
      { id: "subsection", label: "小段", outputHeaders: ["小段"], aliases: ["小段", "小段別", "subsection"] },
      { id: "buildingNumber", label: "建號", outputHeaders: ["建號"], aliases: ["建號", "建物建號", "buildingNumber"] },
      { id: "buildingAddress", label: "建物門牌", outputHeaders: ["建物門牌號碼", "門牌"], aliases: ["建物門牌號碼", "建物門牌", "門牌號碼", "門牌", "地址"] },
      {
        id: "buildingAreaSqm",
        label: "建物總面積",
      ...
      { id: "relatedLandNumber", label: "座落地號", outputHeaders: ["座落地號", "對應地號"], aliases: ["座落地號", "坐落地號", "座落土地地號", "座落地段地號", "對應地號", "土地地號", "地號"] },
      { id: "registrationOrder", label: "登記次序", outputHeaders: ["登記次序"], aliases: ["登記次序", "登記順位", "次序"] },
      { id: "ownerReferenceId", label: "權利人編號", outputHeaders: ["地主編號"], aliases: ["地主編號", "權利人編號", "所有權人編號", "參考編號"] },
      {
        id: "ownerName",
