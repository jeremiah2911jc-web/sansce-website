  ...
  return (
    ...
    >
      ...
      <section
        style={{
          background:
            "linear-gradient(135deg, #f4f1eb 0%, #edf1ef 34%, #e8eef2 68%, #f3f0ec 100%)",
          color: "#2f3a38",
          position: "relative",
          overflow: "hidden",
        }}
      >
        <div
          style={{
            ...
            opacity: 0.92,
            backgroundImage:
              "radial-gradient(circle at 14% 18%, rgba(206, 217, 210, 0.42) 0%, transparent 30%), radial-gradient(circle at 83% 20%, rgba(198, 212, 224, 0.42) 0%, transparent 28%), radial-gradient(circle at 74% 76%, rgba(215, 224, 214, 0.34) 0%, transparent 24%), radial-gradient(circle at 22% 82%, rgba(225, 217, 205, 0.3) 0%, transparent 22%)",
          }}
        />
        <div
          style={{
            ...
            <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
              <a
                ...
                style={{
                  ...
                  textDecoration: "none",
                  fontFamily: "sans-serif",
                  border: "1px solid rgba(121,135,129,0.16)",
                  boxShadow: "0 6px 20px rgba(140,150,148,0.1)",
              ...
              <a
                href="#contact"
                style={{
                  border: "1px solid rgba(121,135,129,0.22)",
                  color: "#5b6964",
                  padding: "0.72rem 1.45rem",
                  borderRadius: "2rem",
                  fontWeight: 600,
      ...
      {/* 3 cards */}
      <section
        style={{ maxWidth: 1100, margin: "0 auto", padding: "3.1rem 2.5rem 3.6rem" }}
      >
        <div
          style={{
            display: "grid",
        ...
        >
          {[
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, rgba(255,255,255,0.96) 0%, rgba(252,252,251,0.92) 100%)",
                borderRadius: "1.4rem",
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #eef1ee 0%, #e8eded 42%, #e4eaee 100%)",
          padding: "4.5rem 0",
          color: "#2f3a38",
          position: "relative",
          overflow: "hidden",
      ...
      >
        <div
          style={{
            ...
            opacity: 0.65,
            backgroundImage:
              "radial-gradient(circle at 18% 16%, rgba(206, 217, 210, 0.32) 0%, transparent 28%), radial-gradient(circle at 84% 26%, rgba(194, 208, 220, 0.28) 0%, transparent 26%), radial-gradient(circle at 72% 78%, rgba(214, 222, 214, 0.24) 0%, transparent 22%)",
          }}
        />
        <div
          style={{
          ...
          >
            ...
            <div>
              <div
                style={{
                  background:
                    "linear-gradient(135deg, #23353d 0%, #1f3037 55%, #1b2a31 100%)",
                  borderRadius: "2rem",
                  padding: "2rem",
              ...
              >
                ...
                >
                  <div>
                    ...
                    <p style={{ color: "#b8c8cf", fontSize: "0.88rem" }}>
                      Sanze Project Management Consulting Co., Ltd.
                    </p>
                  </div>
                  <p>
                    <span style={{ fontWeight: 700, color: "white" }}>服務電話：</span>
                    0916711323
                  </p>
                  <p>
                  ...
                  <p>
                    <span style={{ fontWeight: 700, color: "white" }}>服務時間：</span>
                    週一至週五 09:00－18:00
                  </p>
                </div>
                ...
                <div style={{ marginTop: "1.8rem", textAlign: "center" }}>
                  ...
                  >
                    <QRCodeSVG
                      value="https://line.me/R/ti/p/@160rlvqj"
                      size={110}
                      bgColor="#ffffff"
                      fgColor="#111111"
                      includeMargin={true}
